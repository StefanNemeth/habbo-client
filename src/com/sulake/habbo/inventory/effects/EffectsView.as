...
package com.sulake.habbo.inventory.effects
{
    ...
    public class EffectsView implements IInventoryView 
    {
        ...
        public function EffectsView(_arg_1:EffectsModel, _arg_2:IHabboWindowManager, _arg_3:IAssetLibrary, _arg_4:IHabboLocalizationManager, _arg_5:IThumbListDataProvider, _arg_6:IThumbListDataProvider)
        {
            ...
            this._SafeStr_8117 = new ThumbListManager(this._assetLibrary, _arg_5, "thumb_bg_png", "thumb_bg_selected_png", this.EffectsView(), this.EffectsView());
            this._SafeStr_8118 = new ThumbListManager(this._assetLibrary, _arg_6, "thumb_bg_png", "thumb_bg_selected_png", this.EffectsView(), this.EffectsView());
            var _local_9:IBitmapWrapperWindow = (this._view.findChildByName("active_items_image") as IBitmapWrapperWindow);
            _local_9.procedure = this.EffectsView;
            var _local_10:IBitmapWrapperWindow = (this._view.findChildByName("inactive_items_image") as IBitmapWrapperWindow);
            _local_10.procedure = this.EffectsView;
            this._view.procedure = this.windowEventProc;
        }
        ...
        public function EffectsView():int
        {
        ...
        public function BadgesView():void
        {
            ...
            var _local_3:Effect = this._SafeStr_4830.EffectsModel(-1);
            if (_local_3 == null){
                _local_1.disable();
                ...
                if (_local_3.isActive){
                    _local_1.disable();
                    this.EffectsView(_local_3.iconImage);
                    _local_2.text = "${inventory.effects.active}";
                    this._windowManager.registerLocalizationParameter("inventory.effects.active", "timeleft", this.EffectsView(_local_3.secondsLeft));
                    this._windowManager.registerLocalizationParameter("inventory.effects.active", "duration", this.EffectsView(_local_3.duration));
                    ...
                    this._windowManager.registerLocalizationParameter("inventory.effects.inactive", "duration", this.EffectsView(_local_3.duration));
        ...
        private function EffectsView(_arg_1:BitmapData):void
        {
            if (this._view == null){
                return;
            };
        ...
        private function EffectsView(_arg_1:int):String
        {
        ...
        private function EffectsView(_arg_1:WindowEvent, _arg_2:IWindow):void
        {
            var _local_3:Point;
            var _local_4:int;
            var _local_5:Effect;
            if (_arg_1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK){
                ...
                if (_local_5 != null){
                    this._SafeStr_4830.EffectsModel(_local_5.type);
                };
            };
        }
        private function EffectsView(_arg_1:WindowEvent, _arg_2:IWindow):void
        ...
        private function windowEventProc(_arg_1:WindowEvent, _arg_2:IWindow):void
        {
            ...
            if (_arg_1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK){
                if (_arg_2.name == "activateEffect_button"){
                    _local_3 = this._SafeStr_4830.EffectsModel(0);
                    if (_local_3 != null){
                        this._SafeStr_4830.EffectsModel(_local_3.type);
                    };
                };
            };
        }
...
// EffectsView = "_-3-z" (String#21499, DoABC#2)
// EffectsView = "_-1kU" (String#18308, DoABC#2)
// EffectsView = "_-23A" (String#19141, DoABC#2)
// EffectsView = "_-0zn" (String#16418, DoABC#2)
// EffectsView = "_-2E9" (String#19573, DoABC#2)
// EffectsView = "_-0EG" (String#14618, DoABC#2)
// EffectsView = "_-03O" (String#14178, DoABC#2)
// EffectsView = "_-0uJ" (String#16214, DoABC#2)
