...
package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
    ...
    public class UserCountIn implements ConditionType 
    {
        ...
        public function Element(_arg_1:IWindowContainer, _arg_2:HabboUserDefinedRoomEvents):void
        {
            ...
            this._SafeStr_7673 = new SliderWindowController(_arg_2, this.UserCountIn(_arg_1), _arg_2.assets, 1, 50, 1);
            this._SafeStr_7673.addEventListener(Event.CHANGE, this.UserCountIn);
            this._SafeStr_7673.setValue(1);
            this._SafeStr_7674 = new SliderWindowController(_arg_2, this.UserCountIn(_arg_1), _arg_2.assets, 1, 50, 1);
            this._SafeStr_7674.addEventListener(Event.CHANGE, this.UserCountIn);
        ...
        private function UserCountIn(_arg_1:IWindowContainer):IWindowContainer
        {
        ...
        private function UserCountIn(_arg_1:Event):void
        {
...
// UserCountIn = "_-3Ku" (String#22319, DoABC#2)
// UserCountIn = "_-0qM" (String#16064, DoABC#2)
// UserCountIn = "_-3Ci" (String#21983, DoABC#2)
// UserCountIn = "_-EE" (String#22780, DoABC#2)
