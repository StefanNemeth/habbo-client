...
package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
    ...
    public class HasStackedFurnis implements ConditionType 
    {
        ...
        public function Element(_arg_1:IWindowContainer):Array
        {
            ...
            _local_2.push(this.HasStackedFurnis(_arg_1).ISelectorWindow().id);
            return (_local_2);
        }
        ...
        public function Element(_arg_1:IWindowContainer, _arg_2:Triggerable):void
        {
            ...
            this.HasStackedFurnis(_arg_1).setSelected(this.HasStackedFurnis(_arg_1, _local_3));
        }
        public function get hasSpecialInputs():Boolean
        {
            return (true);
        }
        private function HasStackedFurnis(_arg_1:IWindowContainer, _arg_2:int):IRadioButtonWindow
        {
            return (IRadioButtonWindow(_arg_1.findChildByName((("eval_" + _arg_2) + "_radio"))));
        }
        private function HasStackedFurnis(_arg_1:IWindowContainer):ISelectorWindow
        {
...
// HasStackedFurnis = "_-QT" (String#23267, DoABC#2)
// HasStackedFurnis = "_-20Q" (String#19028, DoABC#2)
