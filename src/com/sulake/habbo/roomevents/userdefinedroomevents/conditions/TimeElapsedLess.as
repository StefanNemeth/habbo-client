...
package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
    ...
    public class TimeElapsedLess implements ConditionType 
    {
        ...
        {
            return (ConditionCodes._SafeStr_7668);
        }
        ...
        private function StuffsInFormation(_arg_1:Event):void
        {
            ...
            if (_arg_1.type == Event.CHANGE){
                ...
                if (_local_2){
                    ...
                    this._SafeStr_5221.localization.registerParameter("wiredfurni.params.allowbefore", "seconds", _local_5);
                };
            };
        }
...
// _SafeStr_7668 = "_-Ma" (String#23107, DoABC#2)
