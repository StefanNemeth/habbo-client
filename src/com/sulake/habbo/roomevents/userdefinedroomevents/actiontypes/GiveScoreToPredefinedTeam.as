...
package com.sulake.habbo.roomevents.userdefinedroomevents.actiontypes
{
    ...
    public class GiveScoreToPredefinedTeam extends GiveScore 
    {
        ...
        override public function Element(_arg_1:IWindowContainer, _arg_2:Triggerable):void
        {
            super.Element(_arg_1, _arg_2);
            var _local_3:int = _arg_2.intParams[2];
            this.getTeamSelector(_arg_1).setSelected(this.ActorIsInTeam(_arg_1, _local_3));
        }
        override public function Element(_arg_1:IWindowContainer):Array
        {
            var _local_2:Array = super.Element(_arg_1);
