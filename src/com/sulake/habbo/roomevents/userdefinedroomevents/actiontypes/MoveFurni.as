...
package com.sulake.habbo.roomevents.userdefinedroomevents.actiontypes
{
    ...
    public class MoveFurni implements ActionType 
    {
        ...
        public function Element(_arg_1:IWindowContainer, _arg_2:Triggerable):void
        {
            ...
            this.MoveFurni(_arg_1).setSelected(this.MoveFurni(_arg_1, _local_3));
            this.MoveFurni(_arg_1).setSelected(this.MoveFurni(_arg_1, _local_4));
        }
        public function Element(_arg_1:IWindowContainer):Array
        {
            var _local_2:Array = new Array();
            var _local_3:int = this.MoveFurni(_arg_1).ISelectorWindow().id;
            var _local_4:int = this.MoveFurni(_arg_1).ISelectorWindow().id;
        ...
        private function MoveFurni(_arg_1:IWindowContainer, _arg_2:int):IRadioButtonWindow
        {
        ...
        private function MoveFurni(_arg_1:IWindowContainer):ISelectorWindow
        {
...
// MoveFurni = "_-0rB" (String#16094, DoABC#2)
// MoveFurni = "_-1qS" (String#18562, DoABC#2)
// MoveFurni = "_-0Lh" (String#14900, DoABC#2)
// MoveFurni = "_-2wY" (String#21329, DoABC#2)
