...
package com.sulake.habbo.roomevents.userdefinedroomevents.actiontypes
{
    ...
    public class MoveToDirection implements ActionType 
    {
        ...
        public function Element(_arg_1:IWindowContainer, _arg_2:Triggerable):void
        {
            ...
            this.MoveToDirection(_arg_1).setSelected(this.MoveToDirection(_arg_1, _local_3));
            this.MoveToDirection(_arg_1).setSelected(this.MoveToDirection(_arg_1, _local_4));
        }
        public function Element(_arg_1:IWindowContainer):Array
        {
            var _local_2:Array = new Array();
            _local_2.push(this.MoveToDirection(_arg_1).ISelectorWindow().id);
            _local_2.push(this.MoveToDirection(_arg_1).ISelectorWindow().id);
            return (_local_2);
        }
        ...
        private function MoveToDirection(_arg_1:IWindowContainer, _arg_2:int):IRadioButtonWindow
        {
        ...
        private function MoveToDirection(_arg_1:IWindowContainer):ISelectorWindow
        {
...
// MoveToDirection = "_-lf" (String#24096, DoABC#2)
// MoveToDirection = "_-1z" (String#18926, DoABC#2)
// MoveToDirection = "_-96" (String#22585, DoABC#2)
// MoveToDirection = "_-17x" (String#16771, DoABC#2)
