...
package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
    ...
    public class WallPlane extends Plane 
    {
        ...
        public function render(_arg_1:BitmapData, _arg_2:Number, _arg_3:Number, _arg_4:Number, _arg_5:IVector3d, _arg_6:Boolean):BitmapData
        {
            ...
            var _local_9:Point = _local_7.geometry.RoomGeometry(new Vector3d(0, 0, (_arg_3 / _local_7.geometry.scale)));
            var _local_10:Point = _local_7.geometry.RoomGeometry(new Vector3d(0, (_arg_2 / _local_7.geometry.scale), 0));
