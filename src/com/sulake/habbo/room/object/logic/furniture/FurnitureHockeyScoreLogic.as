    ...
    public class FurnitureHockeyScoreLogic extends FurnitureLogic 
    {
            ...
            switch (_arg_1.type){
                case MouseEvent.DOUBLE_CLICK:
                    switch (_arg_1.spriteTag){
                        case "off":
                            _local_5 = new RoomObjectStateChangeEvent(RoomObjectStateChangeEvent.ROSCE_STATE_CHANGE, _local_3, _local_4, 3);
                            break;
                    };
                    break;
        ...
        override public function useObject():void
        {
            ...
            if (object != null){
                ...
                _local_3 = new RoomObjectStateChangeEvent(RoomObjectStateChangeEvent.ROSCE_STATE_CHANGE, _local_1, _local_2, 3);
