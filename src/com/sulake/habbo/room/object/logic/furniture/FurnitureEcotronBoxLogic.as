...
package com.sulake.habbo.room.object.logic.furniture
{
    ...
    public class FurnitureEcotronBoxLogic extends FurnitureLogic 
    {
        ...
        {
            var _local_1:Array = [RoomObjectWidgetRequestEvent.REOE_WIDGET_REQUEST_ECOTRONBOX];
        ...
        override public function useObject():void
        {
            ...
            if (((!((eventDispatcher == null))) && (!((object == null))))){
                ...
                _local_3 = new RoomObjectWidgetRequestEvent(RoomObjectWidgetRequestEvent.REOE_WIDGET_REQUEST_ECOTRONBOX, _local_1, _local_2);
