...
package com.sulake.habbo.catalog.viewer.widgets
{
    ...
    public class RecyclerCatalogWidget extends CatalogWidget implements ICatalogWidget, IRecyclerVisualization 
    {
        ...
        public function displayTimeOutView(_arg_1:int):void
        {
        ...
        private function renderSlotGraphics():void
        {
            ...
            var _local_1:BitmapData = this.getAssetBitmapData("ctlg_recycler_slot_bg");
            if (_local_1 == null){
                return;
            };
            _local_2 = 1;
            while (_local_2 <= RecyclerLogic._SafeStr_10336) {
                ...
                if (_local_3 != null){
                    ...
                    _local_3.procedure = this.onSlotMouseEvent;
                };
                _local_2++;
            };
            _local_2 = 1;
        ...
        public function updateSlots():void
        {
            ...
            while (_local_1 < RecyclerLogic._SafeStr_10336) {
                ...
                _local_3 = this.recycler.getSlotContent(_local_1);
                if (_local_3 == null){
                    _local_2.bitmap = new BitmapData(1, 1, true, 0xFFFFFF);
                }
                else {
                    _local_4 = this.getFurniImageResult(_local_3);
        ...
        private function getFurniImageResult(_arg_1:FurniSlotItem):ImageResult
        {
        ...
        private function onMainContainerEvent(_arg_1:WindowEvent, _arg_2:IWindow):void
        {
            var _local_3:IRoomEngine = page.viewer.roomEngine;
            if (_local_3 == null){
                return;
            };
            var _local_4:ISelectedRoomObjectData = _local_3.getSelectedObjectData(_local_3.activeRoomId, _local_3.activeRoomCategory);
            switch (_arg_1.type){
                case WindowMouseEvent.WME_OUT:
                    if (this._SafeStr_10534 != null){
                        this._SafeStr_10534.resetIcon();
                    };
                    return;
                case WindowMouseEvent.WME_MOVE:
                    if (this._SafeStr_10534 != null){
                        this._SafeStr_10534.onMainContainerEvent(_arg_1, _arg_2, _local_4);
                    };
                    return;
        ...
        public function updateRecycleButton(_arg_1:Boolean):void
        {
            ...
            if (_local_2 != null){
                if (_arg_1){
                    _local_2.enable();
                    _local_2.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK, this.onRecycleButtonClick);
                }
                else {
                    _local_2.disable();
                };
        ...
        private function onRecycleButtonClick(_arg_1:WindowMouseEvent):void
        {
            if (this.recycler != null){
        ...
        private function getAssetBitmapData(_arg_1:String):BitmapData
        {
...
// renderSlotGraphics = "_-rG" (String#24327, DoABC#2)
// getAssetBitmapData = "_-2Sv" (String#20157, DoABC#2)
// onSlotMouseEvent = "_-0vF" (String#16246, DoABC#2)
// getSelectedObjectData = "_-2oq" (String#899, DoABC#2)
// onRecycleButtonClick = "_-1mP" (String#18396, DoABC#2)
