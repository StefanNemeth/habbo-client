    ...
    public class OfficialRoomEntryManager implements IDisposable 
    {
        ...
        public function refreshAdFooter(_arg_1:IWindowContainer):void
        {
            ...
            if (_local_4.numChildren < 1){
                _local_4.addChild(this.createEntry(1));
            };
        ...
        public function createEntry(_arg_1:int):IWindowContainer
        {
            ...
            _local_2.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER, this.onCellMouseOver);
            _local_2.addEventListener(WindowMouseEvent.WME_OUT, this.onCellMouseOut);
            _local_2.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK, this.onCellMouseClick);
        ...
        public function refreshEntry(_arg_1:IWindowContainer, _arg_2:Boolean, _arg_3:int, _arg_4:OfficialRoomEntryData):void
        {
            ...
            if (_arg_2){
                ...
                if (_arg_4.type == OfficialRoomEntryData._SafeStr_4116){
                    this.refreshFolderEntry(_arg_1, _arg_4);
                }
                else {
                    this.refreshNormalEntry(_arg_1, _arg_4);
                };
                _arg_1.visible = true;
            }
            else {
        ...
        {
            this.refreshCell(_arg_1, _arg_2);
            this.refreshDetails(_arg_1, _arg_2);
        ...
        private function refreshUserCount(_arg_1:IWindowContainer, _arg_2:OfficialRoomEntryData):void
        {
            ...
            var _local_4:int;
            var _local_5:int;
            if (((_arg_2.showDetails) && ((((_arg_2.type == OfficialRoomEntryData._SafeStr_4125)) || ((_arg_2.type == OfficialRoomEntryData._SafeStr_4124)))))){
                _local_3 = 3;
                _local_4 = 34;
                _local_5 = 13;
        ...
        private function refreshCell(_arg_1:IWindowContainer, _arg_2:OfficialRoomEntryData):void
        {
            ...
            _local_3.visible = true;
            _local_3.width = ((_arg_2.showDetails) ? _SafeStr_4102 : _SafeStr_4101);
            this.refreshPicText(_local_3, _arg_2);
            this.refreshRoomImage(_local_3, _arg_2);
        }
        ...
        private function refreshFolderImage(_arg_1:IWindowContainer, _arg_2:OfficialRoomEntryData):void
        {
            ...
            _local_3.visible = false;
            if (_arg_2.picRef != ""){
                this.refreshCustomImage(_arg_2, _local_3);
            };
        }
        private function refreshRoomImage(_arg_1:IWindowContainer, _arg_2:OfficialRoomEntryData):void
        {
            ...
            if (_arg_2.picRef != ""){
                ...
                if (_arg_2.publicRoomData != null){
                    this.refreshPublicSpaceImage(_arg_1, _arg_2, _local_3);
                }
                else {
                    if (_arg_2.guestRoomData != null){
                        this.refreshGuestRoomImage(_arg_1, _arg_2, _local_3);
                    }
                    else {
                        this.refreshEmptyImage(_arg_1, _arg_2, _local_3);
                    };
                };
            };
        }
        private function refreshPublicSpaceImage(_arg_1:IWindowContainer, _arg_2:OfficialRoomEntryData, _arg_3:IBitmapWrapperWindow):void
        {
            var _local_4:String = this._SafeStr_4105.resolveRoomImageName(_arg_2);
            var _local_5:String = ((("publicSpace." + _local_4) + ".") + _arg_2.showDetails);
            ...
            _arg_3.x = ((_arg_2.showDetails) ? _SafeStr_4103 : 0);
        ...
        private function getEntry(_arg_1:IWindow):OfficialRoomEntryData
        {
            ...
            return ((((_local_2.parent.name == "ad_cont")) ? this.findAdEntry() : this.findEntryInOfficialRoomList(_local_2)));
        }
        ...
        private function refreshDetails(_arg_1:IWindowContainer, _arg_2:OfficialRoomEntryData):void
        {
            ...
            this.refreshEntryCaption(_local_3, _arg_2);
            this.refreshEntryDesc(_local_3, _arg_2);
...
// onCellMouseOver = "_-c4" (String#23716, DoABC#2)
// onCellMouseOut = "_-0qr" (String#16081, DoABC#2)
// onCellMouseClick = "_-1By" (String#16939, DoABC#2)
// getBgColor = "_-1GR" (String#600, DoABC#2)
// hideChildren = "_-14q" (String#1615, DoABC#2)
// _SafeStr_4116 = "_-0nP" (String#15953, DoABC#2)
// refreshFolderEntry = "_-04z" (String#14240, DoABC#2)
// refreshNormalEntry = "_-2AH" (String#19415, DoABC#2)
// refreshCell = "_-22Y" (String#19112, DoABC#2)
// refreshDetails = "_-39i" (String#21872, DoABC#2)
// refreshUserCount = "_-2dF" (String#6816, DoABC#2)
// popupCaption = "_-041" (String#14202, DoABC#2)
// refreshFolderImage = "_-0rm" (String#16112, DoABC#2)
...
// refreshPicText = "_-1lY" (String#18355, DoABC#2)
// refreshRoomImage = "_-3LA" (String#22331, DoABC#2)
// refreshCustomImage = "_-D6" (String#22733, DoABC#2)
// refreshPublicSpaceImage = "_-16J" (String#16710, DoABC#2)
// guestRoomData = "_-ab" (String#23656, DoABC#2)
// refreshGuestRoomImage = "_-0HJ" (String#14732, DoABC#2)
// refreshEmptyImage = "_-Pj" (String#23235, DoABC#2)
...
// setEnterArrowVisibility = "_-2HZ" (String#19708, DoABC#2)
// handleClick = "_-00I" (String#14066, DoABC#2)
...
// findAdEntry = "_-0x4" (String#16315, DoABC#2)
// findEntryInOfficialRoomList = "_-ac" (String#23657, DoABC#2)
// officialRooms = "_-f3" (String#23847, DoABC#2)
// entries = "_-1eU" (String#18076, DoABC#2)
// refreshEntryCaption = "_-1E7" (String#17033, DoABC#2)
// refreshEntryDesc = "_-0G2" (String#14685, DoABC#2)
// getPopupCaption = "_-1r8" (String#18587, DoABC#2)
// getPopupDesc = "_-SS" (String#23344, DoABC#2)
