    ...
    public class PopupCtrl 
    {
        ...
        public function dispose():void
        {
            ...
            if (this._SafeStr_11276){
                this._SafeStr_11276.removeEventListener(TimerEvent.TIMER, this.PopupCtrl);
                this._SafeStr_11276.reset();
                this._SafeStr_11276 = null;
            };
            if (this._SafeStr_11277){
                this._SafeStr_11277.removeEventListener(TimerEvent.TIMER, this.PopupCtrl);
                this._SafeStr_11277.reset();
                this._SafeStr_11277 = null;
            };
        }
        public function PopupCtrl(_arg_1:IWindow):void
        {
            if (this._SafeStr_11278 == null){
                ...
                this._SafeStr_11278.procedure = this.PopupCtrl;
            };
            Util.InfostandWidget(this._SafeStr_11278);
        ...
        private function PopupCtrl(_arg_1:WindowEvent, _arg_2:IWindow):void
        {
...
// PopupCtrl = "_-2Lk" (String#19874, DoABC#2)
