    ...
    public class TeaserFurniWidget extends RoomWidgetBase 
    {
        ...
        override public function get mainWindow():IWindow
        {
            ...
            if (!this._window){
                switch (this._SafeStr_5978){
                    ...
                    case this._SafeStr_5961:
                        if (this._status == this._SafeStr_5965){
                            ...
                            this.sendConversionPoint(("viral_" + this._campaignID), "client.show.locked");
                            _local_2 = this._SafeStr_5974;
                        }
                        else {
                            if (this._status == this._SafeStr_5966){
                                _local_1 = (assets.getAssetByName("notification_gift_unlocked") as XmlAsset);
                                this.sendConversionPoint(("viral_" + this._campaignID), "client.show.unlocked");
                                ...
                                if (this._status == this._SafeStr_5967){
                                    ...
                                    this.sendConversionPoint(("viral_" + this._campaignID), "client.show.no_fb");
                                    ...
                                    if (this._status == this._SafeStr_5968){
                                        _local_1 = (assets.getAssetByName("notification_gift_alert") as XmlAsset);
                                        this.sendConversionPoint(("viral_" + this._campaignID), "client.show.not_enough_fb_friends");
                                        ...
                                        if (this._status == this._SafeStr_5969){
                                            ...
                                            if (this._status == this._SafeStr_5970){
                                                _local_1 = (assets.getAssetByName("notification_gift_alert") as XmlAsset);
                                                this.sendConversionPoint(("viral_" + this._campaignID), "client.show.campaign_closed");
                ...
                this.setDecoImage(_local_5, this._SafeStr_5972);
                _local_2 = _local_2.replace("%campaign%", this._campaignID);
                this.setDecoImage(_local_2, this._SafeStr_5971);
                if (_local_3){
                ...
                if (_local_7 != null){
                    _local_7.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK, this.onTeaserOkButton);
                };
                _local_7 = this._window.findChildByName("no_fb_btn");
                if (_local_7 != null){
                    _local_7.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK, this.onNoFbButton);
                };
                _local_7 = this._window.findChildByName("received_ok_btn");
                if (_local_7 != null){
                    _local_7.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK, this.onReceivedOkButton);
                };
                _local_7 = this._window.findChildByName("skip_btn");
                if (_local_7 != null){
                    _local_7.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK, this.onSkipButton);
                };
                _local_7 = this._window.findChildByName("post_btn");
                if (_local_7 != null){
                    _local_7.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK, this.onPostButton);
                };
                _local_7 = this._window.findChildByName("open_btn");
                if (_local_7 != null){
                    _local_7.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK, this.onOpenButton);
                };
            };
            return (this._window);
        }
        ...
        private function onNoFbButton(_arg_1:WindowEvent):void
        {
            this.hideInterface();
        }
        private function onTeaserOkButton(_arg_1:WindowEvent):void
        {
        ...
        private function onReceivedOkButton(_arg_1:WindowEvent):void
        {
            this.hideInterface();
        }
        private function onSkipButton(_arg_1:WindowEvent):void
        {
            this.sendConversionPoint(("viral_" + this._campaignID), "client.skip_post");
            this.hideInterface();
        }
        private function onPostButton(_arg_1:WindowEvent):void
        {
            ...
            this.sendConversionPoint(("viral_" + this._campaignID), "client.start_post", this._shareId);
        ...
        private function onOpenButton(_arg_1:WindowEvent):void
        {
            var _local_2:RoomWidgetViralFurniMessage;
            if (messageListener != null){
            ...
            if (this._inventory){
                if (this._itemCategory != 0){
                    this._inventory.toggleInventoryPage((((this._itemCategory == 1)) ? InventoryCategory._SafeStr_5995 : InventoryCategory._SafeStr_5996));
                };
            };
            this.sendConversionPoint(("viral_" + this._campaignID), "client.open_gift");
        }
        private function sendConversionPoint(_arg_1:String, _arg_2:String, _arg_3:String="", _arg_4:int=0):void
        {
        ...
        private function setDecoImage(_arg_1:String, _arg_2:String):void
        {
        ...
        function onDecoImageReady(_arg_1:ImageDownloader):void
        {
            if (disposed){
                return;
            };
            ...
            this.setDecoImage(_arg_1.imageName, _arg_1.viewElementID);
        }
...
// setDecoImage = "_-2Zm" (String#20431, DoABC#2)
// onTeaserOkButton = "_-2dy" (String#20600, DoABC#2)
// onNoFbButton = "_-04Z" (String#14225, DoABC#2)
// onReceivedOkButton = "_-0-m" (String#14044, DoABC#2)
// onSkipButton = "_-0xZ" (String#16335, DoABC#2)
// onPostButton = "_-2g6" (String#20697, DoABC#2)
// onOpenButton = "_-2S2" (String#20120, DoABC#2)
