...
package com.sulake.habbo.ui.widget.memenu
{
    ...
    public class MeMenuWidget extends RoomWidgetBase 
    {
        ...
        public function MeMenuWidget(_arg_1:IRoomWidgetHandler, _arg_2:IHabboWindowManager, _arg_3:IAssetLibrary, _arg_4:IHabboLocalizationManager, _arg_5:IEventDispatcher, _arg_6:IHabboConfigurationManager)
        {
            ...
            this.MeMenuWidget(_SafeStr_3858);
            this.hide();
        }
        ...
        private function get mainContainer():IWindowContainer
        {
            ...
            if (this._InventoryMainView == null){
                ...
                if (_local_1){
                    this._InventoryMainView = (windowManager.buildFromXML((_local_1.content as XML)) as IWindowContainer);
                };
            };
            if (this._InventoryMainView){
                return ((this._InventoryMainView.findChildByTag("MAIN_CONTENT") as IWindowContainer));
            };
            return (null);
        }
        public function MeMenuWidget(_arg_1:String):void
        {
        ...
        public function MeMenuWidget():void
        {
            var _local_1:int;
            var _local_2:Rectangle;
            if (((((this._SafeStr_3864) && (this._SafeStr_3864.window))) && (this._InventoryMainView))){
                _local_1 = 5;
                ...
                if (((((((this._config.getBoolean("simple.memenu.enabled", false)) && (this.handler))) && (this.handler.container))) && (this.handler.container.toolbar))){
                    ...
                    this._InventoryMainView.x = (_local_2.right + _local_1);
                    this._InventoryMainView.y = (_local_2.bottom - this._InventoryMainView.height);
                }
                else {
                    this._InventoryMainView.x = _SafeStr_3863.x;
                    this._InventoryMainView.y = (_SafeStr_3863.y - this.mainContainer.height);
                };
            };
        }
        override public function RoomChatWidget(_arg_1:IEventDispatcher):void
        {
            ...
            _arg_1.addEventListener(RoomWidgetWaveUpdateEvent.RWUE_WAVE, this.MeMenuWidget);
            _arg_1.addEventListener(RoomWidgetDanceUpdateEvent.RWUE_DANCE, this.MeMenuWidget);
            _arg_1.addEventListener(RoomWidgetUpdateEffectsUpdateEvent.RWUEUE_UPDATE_EFFECTS, this.MeMenuWidget);
            _arg_1.addEventListener(RoomWidgetToolbarClickedUpdateEvent.RWUE_REQUEST_ME_MENU_TOOLBAR_CLICKED, this.RoomEngine);
            _arg_1.addEventListener(RoomWidgetAvatarEditorUpdateEvent.RWUE_AVATAR_EDITOR_CLOSED, this.MeMenuWidget);
            _arg_1.addEventListener(RoomWidgetAvatarEditorUpdateEvent.RWUE_HIDE_AVATAR_EDITOR, this.MeMenuWidget);
            _arg_1.addEventListener(RoomWidgetRoomObjectUpdateEvent.RWROUE_OBJECT_DESELECTED, this.MeMenuWidget);
            _arg_1.addEventListener(RoomWidgetHabboClubUpdateEvent.RWBIUE_HABBO_CLUB, this.MeMenuWidget);
            _arg_1.addEventListener(RoomWidgetUserInfoUpdateEvent.RWUIUE_OWN_USER, this.InfostandWidget);
            _arg_1.addEventListener(RoomWidgetSettingsUpdateEvent.RWSUE_SETTINGS, this.MeMenuWidget);
            _arg_1.addEventListener(RoomWidgetTutorialEvent.HHTPNUFWE_AE_STARTED, this.MeMenuWidget);
            _arg_1.addEventListener(RoomWidgetTutorialEvent.HHTPNUFWE_AE_HIGHLIGHT, this.MeMenuWidget);
            _arg_1.addEventListener(RoomWidgetPurseUpdateEvent.RWPUE_CREDIT_BALANCE, this.onCreditBalance);
            _arg_1.addEventListener(RoomWidgetRoomEngineUpdateEvent.RWREUE_NORMAL_MODE, this.MeMenuWidget);
            _arg_1.addEventListener(RoomWidgetRoomEngineUpdateEvent._SafeStr_3911, this.MeMenuWidget);
        ...
        override public function RoomChatWidget(_arg_1:IEventDispatcher):void
        {
            ...
            _arg_1.removeEventListener(RoomWidgetWaveUpdateEvent.RWUE_WAVE, this.MeMenuWidget);
            _arg_1.removeEventListener(RoomWidgetDanceUpdateEvent.RWUE_DANCE, this.MeMenuWidget);
            _arg_1.removeEventListener(RoomWidgetUpdateEffectsUpdateEvent.RWUEUE_UPDATE_EFFECTS, this.MeMenuWidget);
            _arg_1.removeEventListener(RoomWidgetToolbarClickedUpdateEvent.RWUE_REQUEST_ME_MENU_TOOLBAR_CLICKED, this.RoomEngine);
            _arg_1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.RWROUE_OBJECT_DESELECTED, this.MeMenuWidget);
            _arg_1.removeEventListener(RoomWidgetHabboClubUpdateEvent.RWBIUE_HABBO_CLUB, this.MeMenuWidget);
            _arg_1.removeEventListener(RoomWidgetAvatarEditorUpdateEvent.RWUE_AVATAR_EDITOR_CLOSED, this.MeMenuWidget);
            _arg_1.removeEventListener(RoomWidgetAvatarEditorUpdateEvent.RWUE_HIDE_AVATAR_EDITOR, this.MeMenuWidget);
            _arg_1.removeEventListener(RoomWidgetUserInfoUpdateEvent.RWUIUE_OWN_USER, this.InfostandWidget);
            _arg_1.removeEventListener(RoomWidgetSettingsUpdateEvent.RWSUE_SETTINGS, this.MeMenuWidget);
            _arg_1.removeEventListener(RoomWidgetTutorialEvent.HHTPNUFWE_AE_HIGHLIGHT, this.MeMenuWidget);
            _arg_1.removeEventListener(RoomWidgetTutorialEvent.HHTPNUFWE_AE_STARTED, this.MeMenuWidget);
            _arg_1.removeEventListener(RoomWidgetPurseUpdateEvent.RWPUE_CREDIT_BALANCE, this.onCreditBalance);
            _arg_1.removeEventListener(RoomWidgetRoomEngineUpdateEvent.RWREUE_NORMAL_MODE, this.MeMenuWidget);
            _arg_1.removeEventListener(RoomWidgetRoomEngineUpdateEvent.RWREUE_NORMAL_MODE, this.MeMenuWidget);
        }
        public function hide(_arg_1:RoomWidgetRoomObjectUpdateEvent=null):void
        {
            if (this._SafeStr_3864 != null){
                this._InventoryMainView.removeChild(this._SafeStr_3864.window);
                this._SafeStr_3864.dispose();
                this._SafeStr_3864 = null;
            };
        ...
        private function MeMenuWidget(_arg_1:RoomWidgetSettingsUpdateEvent):void
        {
            if (!this._isActive){
                return;
            };
            if (this._SafeStr_3864.window.name == _SafeStr_3862){
                (this._SafeStr_3864 as MeMenuSoundSettingsView).MeMenuSoundSettingsView(_arg_1);
            };
        }
        private function MeMenuWidget(_arg_1:RoomWidgetTutorialEvent):void
        {
            switch (_arg_1.type){
                case RoomWidgetTutorialEvent.HHTPNUFWE_AE_HIGHLIGHT:
                    ...
                    (this._SafeStr_3864 as MeMenuMainView).MeMenuMainView("clothes_icon", _SafeStr_3858, "clothes_highlighter_blue");
                    return;
        ...
        private function RoomEngine(_arg_1:RoomWidgetToolbarClickedUpdateEvent):void
        {
            var _local_2:RoomWidgetMeMenuMessage;
            if (this._isActive){
                if (((!((this._InventoryMainView == null))) && (WindowToggle.WindowToggle(this._InventoryMainView)))){
                    this._InventoryMainView.activate();
                    return;
                };
                this._isActive = false;
        ...
        private function MeMenuWidget(_arg_1:RoomWidgetUpdateEffectsUpdateEvent):void
        {
        ...
        private function MeMenuWidget(_arg_1:Event):void
        {
            if (((!((this._SafeStr_3864 == null))) && (!((this._SafeStr_3864.window.name == _SafeStr_3859))))){
                this.hide();
            };
        }
        private function MeMenuWidget(_arg_1:RoomWidgetAvatarEditorUpdateEvent):void
        {
            if (((!((this._SafeStr_3864 == null))) && ((this._SafeStr_3864.window.name == _SafeStr_3859)))){
                this.MeMenuWidget(_SafeStr_3858);
            };
        ...
        private function MeMenuWidget(_arg_1:RoomWidgetWaveUpdateEvent):void
        {
            Logger.log("[MeMenuWidget] Wave Event received");
        }
        private function MeMenuWidget(_arg_1:RoomWidgetDanceUpdateEvent):void
        {
            Logger.log(("[MeMenuWidget] Dance Event received, style: " + _arg_1.style));
        }
        private function MeMenuWidget(_arg_1:RoomWidgetHabboClubUpdateEvent):void
        {
            ...
            if (_local_2){
                if (this._SafeStr_3864 != null){
                    this.MeMenuWidget(this._SafeStr_3864.window.name);
                };
            };
        }
        ...
        private function MeMenuWidget(_arg_1:RoomWidgetRoomEngineUpdateEvent):void
        {
...
// MeMenuWidget = "_-26C" (String#19262, DoABC#2)
// RWUE_WAVE = "_-1aK" (String#17909, DoABC#2)
// MeMenuWidget = "_-1Hk" (String#17180, DoABC#2)
// RWUE_DANCE = "_-0kM" (String#15844, DoABC#2)
// MeMenuWidget = "_-0cI" (String#15525, DoABC#2)
// RWUEUE_UPDATE_EFFECTS = "_-P2" (String#23208, DoABC#2)
// MeMenuWidget = "_-2xg" (String#21381, DoABC#2)
...
// MeMenuWidget = "_-2ry" (String#21155, DoABC#2)
// RWUE_HIDE_AVATAR_EDITOR = "_-1kI" (String#18301, DoABC#2)
// MeMenuWidget = "_-1KR" (String#17292, DoABC#2)
// RWROUE_OBJECT_DESELECTED = "_-8G" (String#22552, DoABC#2)
// MeMenuWidget = "_-yW" (String#24635, DoABC#2)
// RWBIUE_HABBO_CLUB = "_-0ji" (String#15815, DoABC#2)
// MeMenuWidget = "_-2a7" (String#20446, DoABC#2)
...
// MeMenuWidget = "_-0jj" (String#15816, DoABC#2)
// HHTPNUFWE_AE_STARTED = "_-0Le" (String#14899, DoABC#2)
// MeMenuWidget = "_-1iG" (String#18219, DoABC#2)
...
// MeMenuWidget = "_-rE" (String#24325, DoABC#2)
// _SafeStr_3911 = "native" (String#46040, DoABC#2)
// MeMenuWidget = "_-1fd" (String#18123, DoABC#2)
