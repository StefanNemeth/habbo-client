    ...
    public class AvatarInfoWidgetHandler implements IRoomWidgetHandler 
    {
        ...
        public function set container(_arg_1:IRoomWidgetHandlerContainer):void
        {
            if (((((this._container) && (this._container.toolbar))) && (this._container.toolbar.events))){
                this._container.toolbar.events.removeEventListener(HabboToolbarEvent.HTE_TOOLBAR_CLICK, this.RoomEngine);
            };
            if (((((this._container) && (this._container.sessionDataManager))) && (this._container.sessionDataManager.events))){
                this._container.sessionDataManager.events.removeEventListener(UserNameUpdateEvent._SafeStr_4791, this.AvatarInfoWidgetHandler);
            };
            this._container = _arg_1;
            if (((((this._container) && (this._container.toolbar))) && (this._container.toolbar.events))){
                this._container.toolbar.events.addEventListener(HabboToolbarEvent.HTE_TOOLBAR_CLICK, this.RoomEngine);
            };
            if (((((this._container) && (this._container.sessionDataManager))) && (this._container.sessionDataManager.events))){
                this._container.sessionDataManager.events.addEventListener(UserNameUpdateEvent._SafeStr_4791, this.AvatarInfoWidgetHandler);
            };
        }
        private function RoomEngine(_arg_1:HabboToolbarEvent):void
        {
            if (_arg_1.iconId == HabboToolbarIconEnum.MEMENU){
                if (((this.container.config.getBoolean("simple.memenu.enabled", false)) && (this.container.config.getBoolean("menu.own_avatar.enabled", false)))){
                    ...
                    this.AvatarInfoWidgetHandler();
                };
            };
        }
        private function AvatarInfoWidgetHandler(_arg_1:UserNameUpdateEvent):void
        {
            this._widget.close();
        }
        private function AvatarInfoWidgetHandler():void
        {
        ...
        public function processWidgetMessage(_arg_1:RoomWidgetMessage):RoomWidgetUpdateEvent
        {
            ...
            switch (_arg_1.type){
                ...
                case RoomWidgetUserActionMessage.RWUAM_START_NAME_CHANGE:
                    this._container.habboHelp.HotelMergeUI();
                    break;
...
// AvatarInfoWidgetHandler = "_-1eB" (String#18065, DoABC#2)
// AvatarInfoWidgetHandler = "_-2AD" (String#19412, DoABC#2)
