    ...
    public class NameChangeView 
    {
        ...
        private function NameChangeView():void
        {
            if (!this._SafeStr_11427){
                this._SafeStr_11427 = (this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer);
                if (!this._SafeStr_11427){
                    return;
                };
        ...
        private function NameChangeView():void
        {
            if (!this._SafeStr_11428){
                this._SafeStr_11428 = (this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer);
                if (!this._SafeStr_11428){
                    return;
                };
        ...
        private function NameChangeView(_arg_1:WindowEvent, _arg_2:IWindow):void
        {
            ...
            switch (_arg_2.name){
                ...
                case "header_button_close":
                    this._controller.HabboInventory(TutorialUI.TUI_MAIN_VIEW);
                    return;
            };
        }
