...
package com.sulake.habbo.help.tutorial
{
    ...
    public class TutorialCallGuideBotView implements ITutorialUIView 
    {
        ...
        public function TutorialCallGuideBotView(_arg_1:IItemListWindow, _arg_2:TutorialUI):void
        {
            this._help = _arg_2;
            var _local_3:IWindowContainer = (_arg_2.buildXmlWindow("tutorial_call_guidebot") as IWindowContainer);
            if (_local_3 == null){
                return;
            };
        ...
        {
            return (TutorialUI.TUI_GUIDEBOT_VIEW);
        }
