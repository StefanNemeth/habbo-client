...
package com.sulake.habbo.quest
{
    ...
    public class QuestCompleted implements IDisposable 
    {
        ...
        public function prepare(_arg_1:QuestMessageData):void
        {
            ...
            this.setWindowTitle(((this._quest.lastQuestInCampaign) ? "quests.completed.campaign.title" : "quests.completed.quest.title"));
            ...
            this.setDesc((this._quest.getQuestLocalizationKey() + ".completed"));
...
// onNextQuest = "_-1wY" (String#18823, DoABC#2)
// openForNextQuest = "_-UH" (String#23420, DoABC#2)
// onMoreQuests = "_-1AQ" (String#16877, DoABC#2)
// onCatalogLink = "_-1QV" (String#17532, DoABC#2)
// getTwinkleAnimation = "_-0MD" (String#14924, DoABC#2)
// setWindowTitle = "_-dG" (String#23770, DoABC#2)
// setDesc = "_-0xx" (String#16352, DoABC#2)
