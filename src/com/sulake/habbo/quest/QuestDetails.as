...
package com.sulake.habbo.quest
{
    ...
    public class QuestDetails implements IDisposable 
    {
        ...
        private function openDetails(_arg_1:QuestMessageData):void
        {
            ...
            if (this._window == null){
                ...
                this._window.center();
                _local_8 = this._SafeStr_8017.questController.questsList.createListEntry();
            ...
            var _local_4:int = this.getTextHeight(_local_3);
            if (!_local_2){
            ...
            var _local_5:int = (this.getTextHeight(_local_3) - _local_4);
            var _local_6:int = this.setupLink("link_region", ((_local_3.y + _local_3.height) + _SafeStr_12065));
            ...
            this._SafeStr_8017.questController.questsList.setEntryHeight(_local_8);
        ...
        private function setupLink(_arg_1:String, _arg_2:int):int
        {
            ...
            var _local_4:Boolean = this.hasNavigatorLink();
        ...
        {
            var _local_1:Boolean = this._SafeStr_8017.localization.hasKey((this._quest.getCampaignLocalizationKey() + ".searchtag"));
            var _local_2:Boolean = this._SafeStr_8017.localization.hasKey((this._quest.getCampaignLocalizationKey() + ".searchtag"));
        ...
        public function update(_arg_1:uint):void
        {
            ...
            var _local_2:Boolean = this._SafeStr_8017.questController.questsList.refreshDelay(this._window, this._quest);
            if (_local_2){
                this.openDetails(this._quest);
            };
        }
...
// openDetails = "_-2lz" (String#20917, DoABC#2)
// onDetailsWindowClose = "_-1NS" (String#17416, DoABC#2)
// onLinkProc = "_-1nE" (String#18434, DoABC#2)
// getTextHeight = "_-m-" (String#24111, DoABC#2)
// setupLink = "_-vg" (String#24516, DoABC#2)
// hasCatalogLink = "_-1MD" (String#17368, DoABC#2)
// hasNavigatorLink = "_-090" (String#14409, DoABC#2)
