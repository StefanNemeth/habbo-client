...
package com.sulake.habbo.quest
{
    ...
    public class NextQuestTimer implements IDisposable 
    {
        ...
        private function prepareWindow():void
        {
            ...
            this._window.findChildByName("quest_timer_expanded").procedure = this.NextQuestTimer;
            this._window.findChildByName("quest_timer_contracted").procedure = this.NextQuestTimer;
            this.NextQuestTimer();
        }
        private function refresh():void
        {
            ...
            if (_local_1 < 1){
                ...
                this._SafeStr_8017.questController.QuestTracker(this._quest);
            };
            var _local_2:String = FriendlyTime.getFriendlyTime(this._SafeStr_8017.localization, _local_1);
            var _local_3 = (this._quest.QuestMessageData() + ".delayedmsg");
        ...
        private function NextQuestTimer():void
        {
        ...
        private function QuestTracker(_arg_1:WindowEvent, _arg_2:IWindow):void
        {
            if (_arg_1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK){
                this._SafeStr_8017.questController.questDetails.QuestDetails(this._quest);
            };
        }
        private function NextQuestTimer(_arg_1:WindowEvent, _arg_2:IWindow):void
        {
            if (_arg_1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK){
...
// NextQuestTimer = "_-3IB" (String#22209, DoABC#2)
// QuestTracker = "_-Ll" (String#8119, DoABC#2)
// NextQuestTimer = "_-fq" (String#23882, DoABC#2)
