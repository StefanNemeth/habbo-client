...
package com.sulake.habbo.moderation
{
    ...
    public class PickedIssuesView implements IIssueBrowserView 
    {
        ...
        public function PickedIssuesView(_arg_1:IssueManager, _arg_2:IssueBrowser, _arg_3:IWindowContainer)
        {
            ...
            this._window = (this._SafeStr_11929.createWindow("picked_issues_xml") as IWindowContainer);
            _arg_3.addChild(this._window);
            var _local_4:IItemListWindow = (this._window.findChildByName("issue_list") as IItemListWindow);
            this._SafeStr_11930 = new IssueListView(_arg_1, _arg_2, _local_4, "picked_issues_list_item_xml");
        }
        ...
        {
            var _local_1:Array = this._issueManager.getBundles(IssueManager._SafeStr_11932);
