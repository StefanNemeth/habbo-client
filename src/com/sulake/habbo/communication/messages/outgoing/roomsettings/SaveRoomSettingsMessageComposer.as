...
package com.sulake.habbo.communication.messages.outgoing.roomsettings
{
    ...
    public class SaveRoomSettingsMessageComposer implements IMessageComposer, IDisposable 
    {
        ...
        public function SaveRoomSettingsMessageComposer(_arg_1:SaveableRoomSettingsData)
        {
            ...
            super();
            this._messageArray.push(_arg_1.roomId);
            this._messageArray.push(_arg_1.name);
            this._messageArray.push(_arg_1.description);
            this._messageArray.push(_arg_1.doorMode);
            this._messageArray.push((((_arg_1.password)!==null) ? _arg_1.password : ""));
            this._messageArray.push(_arg_1.maximumVisitors);
            this._messageArray.push(_arg_1.categoryId);
            if (_arg_1.tags){
                _local_2 = [];
                ...
                this._messageArray.push(_local_2.length);
                for each (_local_4 in _local_2) {
                    this._messageArray.push(_local_4);
                };
            }
            else {
                this._messageArray.push(0);
            };
            this._messageArray.push(_arg_1.allowPets);
            this._messageArray.push(_arg_1.allowFoodConsume);
            this._messageArray.push(_arg_1.allowWalkThrough);
            this._messageArray.push(_arg_1.hideWalls);
            this._messageArray.push(_arg_1.wallThickness);
            this._messageArray.push(_arg_1.floorThickness);
        }
