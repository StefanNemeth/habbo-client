...
package com.sulake.habbo.communication
{
    ...
    public interface IHabboCommunicationManager extends IUnknown 
    {
        ...
        function HabboCommunicationManager(_arg_1:String):void;
        function HabboCommunicationManager(_arg_1:Function):IConnection;
        function HabboCommunicationManager(_arg_1:IMessageEvent):void;
        function get mode():int;
        function set mode(_arg_1:int):void;
        function get port():int;
        function HabboCommunicationManager(_arg_1:String, _arg_2:String):IHabboWebLogin;
