...
package com.sulake.habbo.avatar.geometry
{
    public class Vector3D 
    {
        ...
        {
            return ((((this._x * _arg_1.x) + (this._y * _arg_1.y)) + (this._Vector3d * _arg_1.z)));
        }
        public function cross(_arg_1:Vector3D):Vector3D
        {
            var _local_2:Vector3D = new Vector3D();
            _local_2.x = ((this._y * _arg_1.z) - (this._Vector3d * _arg_1.y));
            _local_2.y = ((this._Vector3d * _arg_1.x) - (this._x * _arg_1.z));
        ...
        public function normalize():void
        {
            ...
            this._Vector3d = (this._Vector3d * _local_1);
        }
        public function length():Number
        {
            return (Math.sqrt((((this._x * this._x) + (this._y * this._y)) + (this._Vector3d * this._Vector3d))));
        }
        public function toString():String
        {
            return ((((((("Vector3D: (" + this._x) + ",") + this._y) + ",") + this._Vector3d) + ")"));
        }
