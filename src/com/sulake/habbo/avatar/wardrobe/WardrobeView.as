...
package com.sulake.habbo.avatar.wardrobe
{
    ...
    public class WardrobeView implements ISideContentView 
    {
        ...
        private var _modelController:WardrobeModel;
        ...
        public function WardrobeView(_arg_1:WardrobeModel)
        {
            ...
            var _local_2:XmlAsset = (this._modelController.controller.manager.assets.getAssetByName("avatareditor_wardrobe_base") as XmlAsset);
        ...
        public function update():void
        {
            ...
            var _local_1:Array = this._modelController.slots;
            var _local_3:int;
