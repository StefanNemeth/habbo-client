...
package com.sulake.habbo.session
{
    ...
    public class HabboGroupInfoManager 
    {
        ...
        public function set communication(_arg_1:IHabboCommunicationManager):void
        {
            ...
            this._communication.HabboCommunicationManager(new HabboGroupBadgesMessageEvent(this.HabboGroupInfoManager));
            this._communication.HabboCommunicationManager(new HabboGroupDetailsMessageEvent(this.onGroupDetails));
            this._communication.HabboCommunicationManager(new HabboGroupsWhereMemberMessageEvent(this.HabboGroupInfoManager));
            this._communication.HabboCommunicationManager(new HabboGroupJoinFailedMessageEvent(this.HabboGroupInfoManager));
        ...
        {
            this._communication.HabboCommunicationManager(null).send(new GetHabboGroupBadgesMessageComposer());
        }
        ...
        private function onGroupDetails(_arg_1:IMessageEvent):void
        {
            ...
            this.HabboGroupInfoManager().onGroupDetails(_local_2);
        }
        private function HabboGroupInfoManager(_arg_1:IMessageEvent):void
        {
            var _local_2:Array = HabboGroupsWhereMemberMessageEvent(_arg_1).groups;
            this.HabboGroupInfoManager().onGroups(_local_2);
        }
        private function HabboGroupInfoManager(_arg_1:IMessageEvent):void
        {
            ...
            this._SafeStr_13621.windowManager.alert("${group.joinfail.title}", _local_4, 0, this.SessionDataManager);
        }
        private function HabboGroupInfoManager(_arg_1:IMessageEvent):void
        {
        ...
        private function HabboGroupInfoManager():GroupDetailsView
        {
            if (this._SafeStr_13622 == null){
        ...
        public function HabboGroupInfoManager(_arg_1:int):String
        {
...
// HabboGroupInfoManager = "_-9l" (String#22608, DoABC#2)
// onGroupDetails = "_-u1" (String#8767, DoABC#2)
// HabboGroupInfoManager = "_-uh" (String#24479, DoABC#2)
// HabboGroupInfoManager = "_-0ZV" (String#15423, DoABC#2)
// HabboGroupInfoManager = "_-xi" (String#24599, DoABC#2)
