    ...
    public class SessionDataManager extends Component implements ISessionDataManager 
    {
        ...
        override public function dispose():void
        {
            ...
            if (this._SafeStr_13677){
                this._SafeStr_13677.removeEventListener(ProductDataParser._localization, this.SessionDataManager);
        ...
        private function onHabboCommunicationReady(_arg_1:IID, _arg_2:IUnknown):void
        {
            ...
            this._communication.HabboCommunicationManager(new UserChangeMessageEvent(this.onUserChange));
            this._communication.HabboCommunicationManager(new UserNameChangedMessageEvent(this.onUserNameChange));
            this._communication.HabboCommunicationManager(new ChangeUserNameResultMessageEvent(this.onChangeUserNameResult));
            this._communication.HabboCommunicationManager(new AvailabilityStatusMessageEvent(this.onAvailabilityStatus));
            ...
            this._communication.HabboCommunicationManager((new RoomReadyMessageEvent(this.SessionDataManager) as IMessageEvent));
        ...
        private function onAvailabilityStatus(_arg_1:IMessageEvent):void
        {
            ...
            this._systemOpen = _local_2.IssueBrowser;
        ...
        public function SessionDataManager(_arg_1:int):Array
        {
            return (this._SafeStr_13680.UserTagManager(_arg_1));
        }
        public function SessionDataManager(_arg_1:String):BitmapData
        {
            return (this._SafeStr_13681.SessionDataManager(_arg_1));
        }
        public function requestBadgeImage(_arg_1:String):BitmapData
        {
            return (this._SafeStr_13681.SessionDataManager(_arg_1, BadgeImageManager._SafeStr_13617, false));
        }
        public function SessionDataManager(_arg_1:String):BadgeInfo
        {
            return (this._SafeStr_13681.SessionDataManager(_arg_1));
        }
        public function InfoStandUserView(_arg_1:int):void
        {
            if (this._configuration.getKey("groupBadgeInfo.enabled") == "false"){
                this._windowManager.alert("${group.inconstruction.title}", "${group.inconstruction.desc}", 0, this.SessionDataManager);
            }
            else {
        ...
        public function SessionDataManager(_arg_1:int):String
        {
            return (this._SafeStr_13682.HabboGroupInfoManager(_arg_1));
        }
        ...
        public function SessionDataManager(_arg_1:String):BitmapData
        {
            return (this._SafeStr_13681.SessionDataManager(_arg_1, BadgeImageManager._SafeStr_13616));
        }
        ...
        {
            this._SafeStr_13683.SessionDataManager(_arg_1);
        }
        public function SessionDataManager(_arg_1:String):void
        {
            this._SafeStr_13683.SessionDataManager(_arg_1);
        ...
        public function SessionDataManager(_arg_1:int):IFurnitureData
        {
        ...
        public function SessionDataManager(_arg_1:String, _arg_2:int=0):IFurnitureData
        {
            var _local_4:int;
            ...
            if (((!((_local_3 == null))) && ((_arg_2 <= (_local_3.length - 1))))){
                ...
                return (this.SessionDataManager(_local_4));
            };
            return (null);
        }
        public function SessionDataManager(_arg_1:String, _arg_2:int=0):IFurnitureData
        ...
        public function SessionDataManager(userId:int):void
        {
        ...
        public function SessionDataManager(roomId:int, roomCategory:int):void
        {
        ...
        public function SessionDataManager(_arg_1:IProductDataListener=null):Boolean
        {
            var _local_2:String;
            if (this._SafeStr_13684){
                return (true);
            ...
            if (this._SafeStr_13677 == null){
                ...
                this._SafeStr_13677.addEventListener(ProductDataParser._localization, this.SessionDataManager);
            };
            return (false);
        }
        private function SessionDataManager(_arg_1:Event):void
        {
        ...
        private function SessionDataManager():void
        {
        ...
        public function getFurniData(_arg_1:IFurniDataListener):Array
        {
            ...
            var _local_2:Array = this._SafeStr_8133.Map();
            return (_local_2.concat(this._wallItems.Map()));
        }
