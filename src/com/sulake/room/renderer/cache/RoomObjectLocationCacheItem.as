...
package com.sulake.room.renderer.cache
{
    ...
    public class RoomObjectLocationCacheItem 
    {
        ...
        private var _screenLocation:Vector3d = null;
            ...
            if (_local_3){
                ...
                if (((isNaN(_local_6)) || ((_local_6 == 0)))){
                    ...
                    if (((!((_local_7.x == _local_4.x))) || (!((_local_7.y == _local_4.y))))){
                        ...
                        this._screenLocation.assign(_local_5);
                        if (_local_8 != null){
                            this._screenLocation.z = _local_8.z;
                        };
                    }
                    else {
                        this._screenLocation.assign(_local_5);
...
// _screenLocation = "_-2nB" (String#20968, DoABC#2)
