...
package com.sulake.core.runtime
{
    ...
    public interface IContext extends IUnknown 
    {
        ...
        function LibraryLoader():String;
        function IContext(_arg_1:String):void;
        ...
        function IContext(_arg_1:Component, _arg_2:Array):void;
        function IContext(_arg_1:Component):void;
        function IContext(_arg_1:Class, _arg_2:uint=0, _arg_3:ApplicationDomain=null):IUnknown;
        function IContext(_arg_1:XML, _arg_2:Class):Boolean;
        function IContext(_arg_1:IUpdateReceiver, _arg_2:uint):void;
