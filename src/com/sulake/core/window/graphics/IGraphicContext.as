...
package com.sulake.core.window.graphics
{
    ...
    public interface IGraphicContext extends IBitmapDrawable, IEventDispatcher, IDisposable 
    {
        ...
        function WindowController():Rectangle;
        function IGraphicContext(_arg_1:Rectangle, _arg_2:Boolean, _arg_3:Rectangle):void;
        ...
        function IGraphicContext(_arg_1:Rectangle):void;
        function get numChildContexts():int;
        function IGraphicContext(_arg_1:IGraphicContext):IGraphicContext;
        function IGraphicContext(_arg_1:IGraphicContext, _arg_2:int):IGraphicContext;
        function IGraphicContext(_arg_1:int):IGraphicContext;
        function IGraphicContext(_arg_1:IGraphicContext):int;
        function IGraphicContext(_arg_1:IGraphicContext):IGraphicContext;
        function IGraphicContext(_arg_1:int):IGraphicContext;
        function IGraphicContext(_arg_1:IGraphicContext, _arg_2:int):void;
        function IGraphicContext(_arg_1:IGraphicContext, _arg_2:IGraphicContext):void;
        function IGraphicContext(_arg_1:int, _arg_2:int):void;
