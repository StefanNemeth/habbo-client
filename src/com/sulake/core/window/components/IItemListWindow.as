...
package com.sulake.core.window.components
{
    ...
    public interface IItemListWindow extends IWindow, IScrollableWindow, IIterable 
    {
        ...
        function IItemListWindow(_arg_1:IWindow, _arg_2:uint):IWindow;
        function getListItemAt(_arg_1:uint):IWindow;
        function IItemListWindow(_arg_1:uint):IWindow;
        function getListItemByName(_arg_1:String):IWindow;
        function IItemListWindow(_arg_1:String):IWindow;
        function IItemListWindow(_arg_1:IWindow):int;
        function removeListItem(_arg_1:IWindow):IWindow;
        function IItemListWindow(_arg_1:int):IWindow;
        function IItemListWindow(_arg_1:IWindow, _arg_2:int):void;
        function IItemListWindow(_arg_1:IWindow, _arg_2:IWindow):void;
        function IItemListWindow(_arg_1:uint, _arg_2:Array, _arg_3:Boolean=false):uint;
        function IItemListWindow(_arg_1:String, _arg_2:Array, _arg_3:Boolean=false):uint;
        function IItemListWindow(_arg_1:int, _arg_2:int):void;
        function IItemListWindow():void;
        function IItemListWindow():void;
        function IItemListWindow():void;
