...
package com.sulake.core.window.components
{
    ...
    public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot 
    {
        ...
        public function ItemListController(_arg_1:String, _arg_2:uint, _arg_3:uint, _arg_4:uint, _arg_5:WindowContext, _arg_6:Rectangle, _arg_7:IWindow, _arg_8:Function=null, _arg_9:Array=null, _arg_10:Array=null, _arg_11:uint=0)
        {
            ...
            _SafeStr_9161 = ((_background) || (!(testParamFlag(WindowParam._SafeStr_7443))));
            ...
            this._container.addEventListener(WindowEvent.WE_RESIZED, this.containerEventHandler);
            this._container.addEventListener(WindowEvent.WE_CHILD_REMOVED, this.containerEventHandler);
            this._container.addEventListener(WindowEvent.WE_CHILD_RESIZED, this.containerEventHandler);
            this._container.addEventListener(WindowEvent.WE_CHILD_RELOCATED, this.containerEventHandler);
        ...
        override public function dispose():void
        {
            if (!_disposed){
                ...
                this._container.removeEventListener(WindowEvent.WE_RESIZED, this.containerEventHandler);
                this._container.removeEventListener(WindowEvent.WE_CHILD_REMOVED, this.containerEventHandler);
                this._container.removeEventListener(WindowEvent.WE_CHILD_RESIZED, this.containerEventHandler);
                this._container.removeEventListener(WindowEvent.WE_CHILD_RELOCATED, this.containerEventHandler);
                super.dispose();
            };
        }
        ...
        {
            return (this._container.getChildByID(_arg_1));
        }
        ...
        {
            return (this._container.getChildByTag(_arg_1));
        }
        ...
        {
            return (this._container.groupChildrenWithID(_arg_1, _arg_2, _arg_3));
        }
        public function groupListItemsWithTag(_arg_1:String, _arg_2:Array, _arg_3:Boolean=false):uint
        {
            return (this._container.groupChildrenWithTag(_arg_1, _arg_2, _arg_3));
        }
        ...
        public function process(_arg_1:WindowEvent):Boolean
        {
            ...
            switch (_arg_1.type){
                ...
                case WindowMouseEvent.WME_UP_OUTSIDE:
                    if (this._SafeStr_9309){
                        if (this._horizontal){
                            _context.getWindowServices().getGestureAgentService().begin(this, this.scrollAnimationCallback, 0, -(this._SafeStr_9307), 0);
                        }
                        else {
                            _context.getWindowServices().getGestureAgentService().begin(this, this.scrollAnimationCallback, 0, 0, -(this._SafeStr_9308));
                        };
...
// containerEventHandler = "_-03L" (String#14176, DoABC#2)
...
// updateScrollAreaRegion = "_-2gV" (String#20710, DoABC#2)
...
// scrollAnimationCallback = "_-J1" (String#22968, DoABC#2)
