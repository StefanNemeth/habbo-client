...
package com.sulake.core.window.utils
{
    public class ChildEntityArrayReader implements IChildEntityArrayReader 
    {
        ...
        public function getChildByID(_arg_1:uint):IChildEntity
        {
            ...
            var _local_2:uint = this._messageArray.length;
            var _local_4:uint;
            while (_local_4 < _local_2) {
                _local_3 = this._messageArray[_local_4];
        ...
        {
            return (this._messageArray.indexOf(_arg_1));
        }
        public function groupChildrenWithID(_arg_1:uint, _arg_2:Array):uint
        {
            ...
            var _local_6:uint;
            var _local_4:uint;
            var _local_5:uint = this._messageArray.length;
            _local_6 = 0;
            while (_local_6 < _local_5) {
                _local_3 = this._messageArray[_local_6];
                if (_local_3.id == _arg_1){
