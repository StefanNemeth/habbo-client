...
package com.sulake.core.window.utils
{
    public class ChildEntityArray extends ChildEntityArrayReader implements IChildEntityArray 
    {
        ...
        {
            var _local_2:int = _SafeStr_3708.indexOf(_arg_1);
            if (_local_2 < 0){
                return (null);
            };
        ...
        {
            _SafeStr_3708.splice(_arg_2, 0, _arg_1);
            return (_arg_1);
        }
        public function removeChildAt(_arg_1:int):IChildEntity
        {
            var _local_2:IChildEntity = _SafeStr_3708[_arg_1];
            if (_local_2 != null){
                _SafeStr_3708.splice(_arg_1, 1);
                return (_local_2);
            };
            return (null);
        }
        ...
        {
            var _local_3:int = _SafeStr_3708.indexOf(_arg_1);
            if ((((_local_3 > -1)) && (!((_arg_2 == _local_3))))){
                _SafeStr_3708.splice(_local_3, 1);
                _SafeStr_3708.splice(_arg_2, 0, _arg_1);
            };
        }
        public function swapChildren(_arg_1:IChildEntity, _arg_2:IChildEntity):void
        {
            ...
            if (((((!((_arg_1 == null))) && (!((_arg_2 == null))))) && (!((_arg_1 == _arg_2))))){
                _local_3 = _SafeStr_3708.indexOf(_arg_1);
                if (_local_3 < 0){
                    return;
                };
                _local_4 = _SafeStr_3708.indexOf(_arg_2);
                if (_local_4 < 0){
                    return;
                };
                ...
                _SafeStr_3708.splice(_local_4, 1);
                _SafeStr_3708.splice(_local_3, 1);
                _SafeStr_3708.splice(_local_3, 0, _arg_2);
                _SafeStr_3708.splice(_local_4, 0, _arg_1);
            };
        }
        public function swapChildrenAt(_arg_1:int, _arg_2:int):void
        {
            this.swapChildren(_SafeStr_3708[_arg_1], _SafeStr_3708[_arg_2]);
        }
