...
package com.sulake.core.window.utils
{
    public interface IChildEntityArrayReader 
    {
        ...
        function WindowController(_arg_1:uint):IChildEntity;
        function WindowController(_arg_1:String):IChildEntity;
        function getChildByName(_arg_1:String):IChildEntity;
        function getChildIndex(_arg_1:IChildEntity):int;
        function WindowController(_arg_1:uint, _arg_2:Array):uint;
        function WindowController(_arg_1:String, _arg_2:Array):uint;
