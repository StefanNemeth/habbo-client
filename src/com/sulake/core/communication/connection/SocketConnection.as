...
package com.sulake.core.communication.connection
{
    ...
    public class SocketConnection extends EventDispatcher implements IConnection, IDisposable 
    {
        ...
        private var _SocketConnection:IEncryption;
        ...
        public function SocketConnection(_arg_1:String, _arg_2:ICoreCommunicationManager, _arg_3:IConnectionStateListener)
        {
            ...
            this._SafeStr_8830.addEventListener(TimerEvent.TIMER, this.SocketConnection);
            this._SafeStr_8823.addEventListener(Event.CONNECT, this.HabboCommunicationManager);
            this._SafeStr_8823.addEventListener(Event.COMPLETE, this.SocketConnection);
            this._SafeStr_8823.addEventListener(Event.CLOSE, this.PollOfferDialog);
            this._SafeStr_8823.addEventListener(ProgressEvent.SOCKET_DATA, this.SocketConnection);
            this._SafeStr_8823.addEventListener(SecurityErrorEvent.SECURITY_ERROR, this.HabboCommunicationManager);
            this._SafeStr_8823.addEventListener(IOErrorEvent.IO_ERROR, this.HabboCommunicationManager);
        ...
        public function dispose():void
        {
            ...
            if (this._SafeStr_8823){
                this._SafeStr_8823.removeEventListener(Event.CONNECT, this.HabboCommunicationManager);
                this._SafeStr_8823.removeEventListener(Event.COMPLETE, this.SocketConnection);
                this._SafeStr_8823.removeEventListener(Event.CLOSE, this.PollOfferDialog);
                this._SafeStr_8823.removeEventListener(ProgressEvent.SOCKET_DATA, this.SocketConnection);
                this._SafeStr_8823.removeEventListener(SecurityErrorEvent.SECURITY_ERROR, this.HabboCommunicationManager);
                this._SafeStr_8823.removeEventListener(IOErrorEvent.IO_ERROR, this.HabboCommunicationManager);
            ...
            if (this._SafeStr_8830){
                ...
                this._SafeStr_8830.removeEventListener(TimerEvent.TIMER, this.SocketConnection);
            };
        ...
        {
            this.SocketConnection(((("Connecting to " + _arg_1) + ":") + _arg_2));
            if (this._SafeStr_8829){
                this._SafeStr_8829.HabboCommunicationManager(_arg_1, _arg_2);
            };
        ...
        public function SocketConnection(_arg_1:IMessageEvent):void
        {
            if (this.disposed){
                return;
            };
        ...
        public function send(_arg_1:IMessageComposer, _arg_2:int=-1):Boolean
        {
            ...
            if (_local_4 < 0){
                this.SocketConnection(("Could not find registered message composer for " + _arg_1));
                return (false);
            };
            var _local_5:Array = _arg_1.getMessageArray();
            var _local_6:ByteArray = this._protocol.encoder.encode(_local_4, _local_5, _arg_2);
            if (this._SafeStr_8829){
                this._SafeStr_8829.HabboCommunicationManager(String(_local_4), _local_6.toString());
            };
            if (this._SocketConnection != null){
                _local_3 = this._SocketConnection.encipher(_local_6);
            }
            else {
                _local_3 = _local_6;
            };
            if (this._SafeStr_8823.connected){
                ...
                this.SocketConnection("[SOCKET] Not connected.");
                return (false);
            };
            return (true);
        }
        public function SocketConnection(_arg_1:IEncryption):void
        {
            this._SocketConnection = _arg_1;
        }
        ...
        override public function toString():String
        {
            ...
            return ((_local_1 + (("Encryption: " + this._SocketConnection) + "\n")));
        }
        public function processReceivedData():void
        {
            ...
            try {
                for each (message in receivedMessages) {
                    ...
                    if (this._SafeStr_8829){
                        this._SafeStr_8829.HabboCommunicationManager(String(id), data.toString());
                    };
                        ...
                        if (parserClass != null){
                            ...
                            if (parserClass != parserClassCurrent){
                                ...
                                if (!parserInstance.flush()){
                                    this.SocketConnection((">>[SocketConnection] Message Event Parser wasn't flushed: " + [id, parserClass, parserInstance]));
                                }
                                else {
                ...
                if (offset == this._SafeStr_8824.length){
                    ...
                    if (offset > 0){
                        ...
                        this.SocketConnection(((("[SOCKET REST] offset: " + offset) + " rest: ") + this._SafeStr_8824.toString()));
                    };
                };
            }
            catch(e:Error) {
        ...
        private function SocketConnection(_arg_1:ProgressEvent):void
        {
            if (this._SafeStr_8823 == null){
                return;
            };
        ...
        {
            this.SocketConnection("[SocketConnection] Connected");
            this._SafeStr_8830.stop();
        ...
        private function PollOfferDialog(_arg_1:Event):void
        {
            this._SafeStr_8830.stop();
            this.SocketConnection("[SocketConnection] Closed");
        ...
        {
            this._SafeStr_8830.stop();
            this.SocketConnection("[SocketConnection] Complete");
        ...
        {
            this._SafeStr_8830.stop();
            this.SocketConnection(("[SocketConnection] Security Error: " + _arg_1.text));
        ...
        {
            this._SafeStr_8830.stop();
            this.SocketConnection(("[SocketConnection] IO Error: " + _arg_1.text));
        ...
        private function SocketConnection(_arg_1:TimerEvent):void
        {
            this._SafeStr_8830.stop();
            this.SocketConnection("[SocketConnection] TimeOut Error");
        ...
        private function SocketConnection(_arg_1:String):void
        {
        }
...
// _SocketConnection = "_-2w9" (String#21316, DoABC#2)
